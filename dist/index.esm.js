...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FFCFDD", backgroundDisabled: "#E9EAEB", contrast: "#006AB6", invertedContrast: "#5CDB95", input: "#eeeaf4", tertiary: "#FF7A00", text: "#D71F55", textDisabled: "#082c4e", textSubtle: "#006AB6", borderColor: "#f8f9fa", card: "#FFFDF5", gradients: {
